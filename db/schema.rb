...
ActiveRecord::Schema.define(:version => 20141009064907) do
  ...
  create_table "parameters", :force => true do |t|
    ...
    t.string   "type"
    t.integer  "priority"
    t.boolean  "is_property"
    t.boolean  "hidden_value", :default => false
  end

  add_index "parameters", ["reference_id", "name"], :name => "index_parameters_on_reference_id_and_name", :unique => true
  ...
  create_table "staypuft_deployment_role_hostgroups", :force => true do |t|
  ...
  add_index "staypuft_deployment_role_hostgroups", ["deployment_id"], :name => "index_staypuft_deployment_role_hostgroups_on_deployment_id"
  add_index "staypuft_deployment_role_hostgroups", ["hostgroup_id"], :name => "index_staypuft_deployment_role_hostgroups_on_hostgroup_id"

  create_table "staypuft_deployments", :force => true do |t|
    t.string   "name",                                 :null => false
    t.text     "description"
    ...
    t.datetime "created_at",                           :null => false
    t.datetime "updated_at",                           :null => false
    t.string   "form_step",    :default => "inactive", :null => false
    t.text     "custom_repos"
  end

  add_index "staypuft_deployments", ["layout_id"], :name => "index_staypuft_deployments_on_layout_id"

  create_table "staypuft_layout_roles", :force => true do |t|
    t.integer  "layout_id",    :null => false
    t.integer  "role_id",      :null => false
    t.datetime "created_at",   :null => false
    t.datetime "updated_at",   :null => false
  ...
  add_index "staypuft_layout_roles", ["layout_id"], :name => "index_staypuft_layout_roles_on_layout_id"
  add_index "staypuft_layout_roles", ["role_id"], :name => "index_staypuft_layout_roles_on_role_id"

  create_table "staypuft_layout_subnet_types", :force => true do |t|
    t.integer  "layout_id",      :null => false
    t.integer  "subnet_type_id", :null => false
    t.datetime "created_at",     :null => false
    t.datetime "updated_at",     :null => false
  end

  create_table "staypuft_layouts", :force => true do |t|
    t.string   "name",        :null => false
    t.text     "description"
    t.datetime "created_at",  :null => false
    t.datetime "updated_at",  :null => false
  ...
  create_table "staypuft_role_classes", :force => true do |t|
    t.integer  "role_id",        :null => false
    t.integer  "puppetclass_id", :null => false
    t.datetime "created_at",     :null => false
    t.datetime "updated_at",     :null => false
  ...
  add_index "staypuft_role_classes", ["puppetclass_id"], :name => "index_staypuft_role_classes_on_puppetclass_id"
  add_index "staypuft_role_classes", ["role_id"], :name => "index_staypuft_role_classes_on_role_id"

  create_table "staypuft_role_services", :force => true do |t|
  ...
  add_index "staypuft_role_services", ["role_id"], :name => "index_staypuft_role_services_on_role_id"
  add_index "staypuft_role_services", ["service_id"], :name => "index_staypuft_role_services_on_service_id"

  create_table "staypuft_roles", :force => true do |t|
    t.string   "name",          :null => false
    t.text     "description"
    t.integer  "min_hosts"
    t.integer  "max_hosts"
    t.datetime "created_at",    :null => false
    t.datetime "updated_at",    :null => false
    t.string   "orchestration"
  end

  create_table "staypuft_service_classes", :force => true do |t|
    t.integer  "service_id",     :null => false
    t.integer  "puppetclass_id", :null => false
    t.datetime "created_at",     :null => false
    t.datetime "updated_at",     :null => false
  ...
  add_index "staypuft_service_classes", ["puppetclass_id"], :name => "index_staypuft_service_classes_on_puppetclass_id"
  add_index "staypuft_service_classes", ["service_id"], :name => "index_staypuft_service_classes_on_service_id"

  create_table "staypuft_services", :force => true do |t|
    t.string   "name",        :null => false
    t.text     "description"
    t.datetime "created_at",  :null => false
    t.datetime "updated_at",  :null => false
  ...
  create_table "staypuft_subnet_types", :force => true do |t|
    t.string   "name",                                       :null => false
    t.datetime "created_at",                                 :null => false
    t.datetime "updated_at",                                 :null => false
    t.boolean  "is_required",             :default => true
    t.boolean  "foreman_managed_ips",     :default => true
    t.boolean  "default_to_provisioning", :default => true
    t.boolean  "dedicated_subnet",        :default => false
  end

  create_table "staypuft_subnet_typings", :force => true do |t|
    t.integer  "deployment_id",  :null => false
    t.integer  "subnet_type_id", :null => false
  ...
  add_index "staypuft_subnet_typings", ["deployment_id"], :name => "index_staypuft_subnet_typings_on_deployment_id"
  add_index "staypuft_subnet_typings", ["subnet_id"], :name => "index_staypuft_subnet_typings_on_subnet_id"
  add_index "staypuft_subnet_typings", ["subnet_type_id"], :name => "index_staypuft_subnet_typings_on_subnet_type_id"
  ...
  add_foreign_key "staypuft_deployment_role_hostgroups", "hostgroups", :name => "staypuft_deployment_role_hostgroups_hostgroup_id_fk"
  add_foreign_key "staypuft_deployment_role_hostgroups", "staypuft_deployments", :name => "staypuft_deployment_role_hostgroups_deployment_id_fk", :column => "deployment_id"
  add_foreign_key "staypuft_deployment_role_hostgroups", "staypuft_roles", :name => "staypuft_deployment_role_hostgroups_role_id_fk", :column => "role_id"

  add_foreign_key "staypuft_deployments", "hostgroups", :name => "staypuft_deployments_hostgroup_id_fk"
  add_foreign_key "staypuft_deployments", "staypuft_layouts", :name => "staypuft_deployments_layout_id_fk", :column => "layout_id"

  add_foreign_key "staypuft_layout_roles", "staypuft_layouts", :name => "staypuft_layout_roles_layout_id_fk", :column => "layout_id"
  add_foreign_key "staypuft_layout_roles", "staypuft_roles", :name => "staypuft_layout_roles_role_id_fk", :column => "role_id"

  add_foreign_key "staypuft_role_classes", "puppetclasses", :name => "staypuft_role_classes_puppetclass_id_fk"
  add_foreign_key "staypuft_role_classes", "staypuft_roles", :name => "staypuft_role_classes_role_id_fk", :column => "role_id"

  add_foreign_key "staypuft_role_services", "staypuft_roles", :name => "staypuft_role_servicess_role_id_fk", :column => "role_id"
  add_foreign_key "staypuft_role_services", "staypuft_services", :name => "staypuft_role_servicess_service_id_fk", :column => "service_id"

  add_foreign_key "staypuft_service_classes", "puppetclasses", :name => "staypuft_service_classes_puppetclass_id_fk"
  add_foreign_key "staypuft_service_classes", "staypuft_services", :name => "staypuft_service_classes_service_id_fk", :column => "service_id"
